  ...
  return (
    <div className='w-screen h-screen bg-background flex justify-center gap-2'>
      <div className='mt-2 p-2 bg-paper self-start rounded'>
        <div className="p-1 flex itens-center justify-between gap-4">
        ...
        <hr className="hr-white" />
        <div className="p-1 flex itens-center justify-between gap-4" style={{ alignItems: 'center' }}>
          <label style={{ height: 'fit-content' }}>File max size in bytes</label>
          <input type="number" className='bg-background p-1 text-base h-auto' style={{ width: 80 }} onChange={e => setFileMaxSize(Number(e.target.value))} value={fileMaxSize} />
        </div>
      </div>
